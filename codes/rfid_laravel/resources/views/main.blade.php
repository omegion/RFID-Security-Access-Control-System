...
<body class="auth-wrapper">
    <div class="all-wrapper menu-side" v-cloak>
        <transition name="fade" mode="out-in" :duration="300">  
            ...
            <div v-else-if="pageStatus == 'cardFound'" key="toggled" class="auth-box-w wider centered">
                ...
                <div class="logged-user-w pb-3" style="    height: 132px;">
                <div class="avatar-w"><img alt="" src="https://randomuser.me/api/portraits/men/{{ rand(1,10) }}.jpg"></div>
                    <div class="logged-user-name">@{{ user.name }}</div>
                    <div class="logged-user-role">@{{ user.title }}</div>
                </div>
                <div class="logged-user-w pt-3" style="    height: 60px;">
                    <a :href="'user-history/'+user.id" class="btn btn-primary">Access History</a>
                </div>
            </div>
        </transition>  
